...
class Text(Element):
    def __init__(
        self, etype: str, text: str, eid: str = None, class_list: List[str] = None
    ):
        super().__init__(etype, text, eid, class_list)


class h1(Text):
    def __init__(self, text: str, eid: str = None, class_list: List[str] = None):
...
class a(Text):
    def __init__(
        self, text: str, href: str, eid: str = None, class_list: List[str] = None
    ):
        super().__init__(self.__class__.__name__, text, eid, class_list)
        self.href = href
